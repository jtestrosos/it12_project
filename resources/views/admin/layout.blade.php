...
@section('sidebar-menu')
    ...
    <a class="nav-link @if(request()->routeIs('admin.patients') || request()->routeIs('admin.patients.archive')) active @endif"
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="submenu-section">
                ...
                <a class="nav-link submenu-link @if(request()->routeIs('admin.services.index')) active @endif"
                    href="{{ route('admin.services.index') }}" data-tooltip="Manage Services">
            ...
            <div class="submenu-section">
                ...
                <a class="nav-link submenu-link @if(request()->routeIs('admin.reports.analytics')) active @endif"
                    href="{{ route('admin.reports.analytics') }}" data-tooltip="Analytics">
                ...
                <a class="nav-link submenu-link @if(request()->routeIs('admin.reports.patients')) active @endif"
                    href="{{ route('admin.reports.patients') }}" data-tooltip="Patient Reports">
                ...
                <a class="nav-link submenu-link @if(request()->routeIs('admin.reports.inventory')) active @endif"
                    href="{{ route('admin.reports.inventory') }}" data-tooltip="Inventory Reports">
