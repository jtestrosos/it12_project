    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3">
            <div class="card-surface p-3">
                ...
                <small class="text-muted">{{ $totalPatients > 0 ? round(($maleCount / $totalPatients) * 100, 1) : 0 }}%</small>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card-surface p-3">
                ...
                <small class="text-muted">{{ $totalPatients > 0 ? round(($femaleCount / $totalPatients) * 100, 1) : 0 }}%</small>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card-surface p-3">
                ...
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $patient->name }}</td>
                                <td class="text-end"><span class="badge bg-primary">{{ $patient->appointments_count }}</span></td>
                            </tr>
                            @empty
                            <tr>
                ...
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $patient->name }}</td>
                                <td class="text-end"><small class="text-muted">{{ $patient->created_at->diffForHumans() }}</small></td>
                            </tr>
                            @empty
                            <tr>
