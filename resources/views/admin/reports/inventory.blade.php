    ...
    <div class="card-surface p-3 mb-4">
        <form action="{{ route('admin.reports.export.inventory') }}" method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="end_date" class="form-control" required value="{{ now()->endOfMonth()->format('Y-m-d') }}">
            </div>
            <div class="col-md-6 d-flex gap-2">
                <button type="submit" class="btn btn-success flex-grow-1">
                    <i class="fas fa-file-excel me-2"></i>Export Excel (Report)
                </button>
                <button type="submit" formaction="{{ route('admin.reports.export.inventory.pdf') }}" class="btn btn-danger flex-grow-1">
                    ...
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $transaction->transaction_type === 'restock' ? 'success' : 'danger' }}">
                    ...
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end"><span class="badge bg-warning">{{ $item->current_stock }}</span></td>
                ...
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $item->item_name }}</td>
                                <td class="text-end">{{ \Carbon\Carbon::parse($item->expiry_date)->format('M d, Y') }}</td>
                                <td class="text-end">
                                    <span class="badge bg-{{ \Carbon\Carbon::parse($item->expiry_date)->diffInDays(now()) < 30 ? 'danger' : 'info' }}">
